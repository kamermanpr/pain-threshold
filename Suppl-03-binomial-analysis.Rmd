...
ggsave(filename = 'figures/fig_1c.png', 
       plot = fig_1c,
       width = 9,
       height = 10.4)
```
...
ggsave(filename = 'figures/fig_1f.png', 
       plot = fig_1f,
       width = 9,
       height = 4.82)
```
...
ggsave(filename = 'figures/fig_1i.png', 
       plot = fig_1i,
       width = 9,
       height = 4.8)
```
...
ggsave(filename = 'figures/fig_1j.png', 
       plot = fig_1j,
       width = 9,
       height = 4.8)
```
...
ggsave(filename = 'figures/fig_1m.png', 
       plot = fig_1m,
       width = 9,
       height = 4.8)
```
...
ggsave(filename = 'figures/fig_1n.png', 
       plot = fig_1n,
       width = 9,
       height = 4.8)
```
