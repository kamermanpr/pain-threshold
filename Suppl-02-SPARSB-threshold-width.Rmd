...
knitr::opts_chunk$set(warning = FALSE,
                      ...
                      fig.align = 'center',
                      fig.retina = 2,
                      fig.path = 'figures/Suppl-02-SPARSB-threshold-width/')
```
...
#### SPARS
```{r spars_scatter, fig.width = 9, fig.height = 6}
...
#### NRS
```{r nrs_scatter, fig.width = 9, fig.height = 6}
# Plot scatter plot of ratings for each individual at every intensity
...
#### SRS
```{r srs_scatter, fig.width = 9, fig.height = 6}
# Plot scatter plot of ratings for each individual at every intensity
...
#### SPARS
```{r spars_ci, fig.width = 9, fig.height = 4.82}
...
ggsave(filename = 'figures/fig_1d.png', 
       plot = fig_1d,
       width = 9,
       height = 4.82)
```
...
#### NRS
```{r nrs_ci, fig.width = 9, fig.height = 6}
# Plot individual CIs at every intensity
...
ggsave(filename = 'figures/fig_1g.png', 
       plot = fig_1g,
       width = 9,
       height = 4.82)
```
...
#### SRS
```{r srs_ci, fig.width = 9, fig.height = 6}
# Plot individual CIs at every intensity
...
ggsave(filename = 'figures/fig_1k.png', 
       plot = fig_1k,
       width = 9,
       height = 4.82)
```
...
## Paper plot (Fig 1e)
fig_1e <- ggplot(data = spars_boot_group) +
    aes(x = intensity) +
    geom_crossbar(aes(y = tri_mean,
                      ymin = lower_ci,
                      ymax = upper_ci,
...
ggsave(filename = 'figures/fig_1e.png', 
       plot = fig_1e,
       width = 10.4,
       height = 10.4)
```
...
## Paper plot (Fig 1h)
fig_1h <- ggplot(data = nrs_boot_group) +
    aes(x = intensity) +
    geom_crossbar(aes(y = tri_mean,
                      ymin = lower_ci,
                      ymax = upper_ci,
...
ggsave(filename = 'figures/fig_1h.png', 
       plot = fig_1h,
       width = 10.4,
       height = 10.4)
```
...
## Paper plot (Fig 1l)
fig_1l <- ggplot(data = srs_boot_group) +
    aes(x = intensity) +
    geom_crossbar(aes(y = tri_mean,
                      ymin = lower_ci,
                      ymax = upper_ci,
...
ggsave(filename = 'figures/fig_1l.png', 
       plot = fig_1l,
       width = 10.4,
       height = 10.4)
```
